 ...
 * track namespaces.
 *
 * @property {Object.<string, Attribute>} attributes A map of attribute name to
 * attribute value.
 *
...
class SaxesParser {
  ...
  /**
   * Event handler for a CDATA section start. This is called when starting the
  ...
  /**
   * Event handler for a CDATA section end. This is called when ending the
   * CDATA section. The default implementation is a no-op.
   */
  onclosecdata() {}
