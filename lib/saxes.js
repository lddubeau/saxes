...
const DOCTYPE_TERMINATOR = QUOTES.concat(OPEN_BRACKET, GREATER);
const DTD_TERMINATOR = QUOTES.concat(LESS, CLOSE_BRACKET);
const XML_DECL_NAME_TERMINATOR = [EQUAL, QUESTION].concat(S_LIST);
const ATTRIB_VALUE_UNQUOTED_TERMINATOR = S_LIST.concat(GREATER, AMP, LESS);
