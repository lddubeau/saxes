...
const S_TEXT_ENTITY = 3; // &amp and such.
const S_OPEN_WAKA = 4; // <
...
const S_ATTRIB_VALUE_ENTITY_Q = 28; // <foo bar="&quot;"
const S_ATTRIB_VALUE_ENTITY_U = 29; // <foo bar=&quot
const S_CLOSE_TAG = 30; // </a
const S_CLOSE_TAG_SAW_WHITE = 31; // </a   >
const S_XML_DECL_NAME_START = 32; // <?xml
const S_XML_DECL_NAME = 33; // <?xml foo
const S_XML_DECL_EQ = 34; // <?xml foo=
const S_XML_DECL_VALUE_START = 35; // <?xml foo=
const S_XML_DECL_VALUE = 36; // <?xml foo="bar"
...
/^[A-Za-z0-9][A-Za-z0-9._-]*$/.");
      ...
      case S_ATTRIB_VALUE_ENTITY_U: {
        ...
        else if ((this.entity.length ? NAME_CHAR : ENTITY_START_CHAR).test(c) &&
