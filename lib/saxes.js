;(function (sax) { // wrapper for non-node envs
  sax.parser = function (opt) { return new SAXParser(opt) }
  ...
  function end (parser) {
    if (parser.sawRoot && !parser.closedRoot) fail(parser, 'Unclosed root tag')
    ...
    parser.closed = true
    emit(parser, 'onend')
    SAXParser.call(parser, parser.opt)
    return parser
  }
